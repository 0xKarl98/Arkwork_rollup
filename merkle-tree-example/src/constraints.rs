...
impl ConstraintSynthesizer<ConstraintF> for MerkleTreeVerification {
    fn generate_constraints(
        ...
        fn verify_membership (
            &self,
            leaf_crh_params : &LeafHash:: Parameters ,
            two_to_one_crh_params : &TwoToOneHash::Parameters ,
            root : &TwoToOneHash::OutputVar,
            leaf : &impl To<ConstraintF> ,
        ) -> Result<Boolean<ConstraintF>, SynthesisError>{
            let expected_root = self.calculate_root(leaf_crh_params , two_to_one_crh_params , leaf)?;
